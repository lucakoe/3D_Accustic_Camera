...
if __name__ == '__main__':
    ...
    recording.record(data_dir, audio_recording_out_filename, syncfile_filename, trigger_device, fps, mic_array_amount,
    ...
    for i in range(mic_array_amount):
        ...
        recording.rearrange_wav_channels(audio_recording_out_path_i, mic_array_layout[i],
